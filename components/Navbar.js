            ...
            <header className="text-white body-font bg-slate-600">
                <div className="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
                    ...
                    <nav className="md:ml-auto md:mr-auto md:text-xl flex flex-wrap items-center text-base justify-center">
                        <a className="mr-5 hover:text-gray-900">General</a>
                        <a className="mr-5 hover:text-gray-900">Business</a>
                        <a className="mr-5 hover:text-gray-900">Sports</a>
                        <a className="mr-5 hover:text-gray-900">Health</a>
                        <a className="mr-5 hover:text-gray-900">Entertainment</a>
                        <a className="mr-5 hover:text-gray-900">Science</a>
